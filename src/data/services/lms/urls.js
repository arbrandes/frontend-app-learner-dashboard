...
export const getEcommerceUrl = () => getAppConfig('org.openedx.frontend.app.learnerDashboard').ECOMMERCE_BASE_URL;
...
export const learningMfeUrl = (url) => updateUrl(getAppConfig('org.openedx.frontend.app.learnerDashboard').LEARNING_BASE_URL, url);
